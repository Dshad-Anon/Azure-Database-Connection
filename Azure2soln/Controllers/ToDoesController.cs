...
namespace Azure2soln.Controllers
{
    public class ToDoesController : Controller
    {
        private readonly Azure2solnContext _context;

        public ToDoesController(Azure2solnContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ToDo != null ? 
                          ...
                          Problem("Entity set 'Azure2solnContext.ToDo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Azure2solnContext.ToDo'  is null.");
            }
            var toDo = await _context.ToDo.FindAsync(id);
            if (toDo != null)
            {
